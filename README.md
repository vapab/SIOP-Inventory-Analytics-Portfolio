...
## 📸 Screenshots (These are just some screenshots to showcase my projects that required extensive hours of back-end development and logic for full automatization) 
